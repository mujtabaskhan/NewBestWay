    ...
    return (
        ...
        >
            <div className="relative z-10 flex flex-col h-full px-8 max-sm:px-10 max-w-7xl mx-auto pt-52 max-lg:!pt-0 max-sm:mt-0 max-sm:!pt-3">
                ...
                <div>
                    <h1 className="text-[70px] max-md:text-[40px] max-sm:text-[30px] leading-[70px] text-[#418874] mb-10 max-xl:mb-3 max-sm:leading-[50px] font-normal">
                        Lets
                        <span className="font-bold font-italic"> Talk</span>
                    </h1>

                    <div className="max-w-4xl">
                        <p className="text-xl text-[#295d4e] leading-[30px] font-flex max-sm:leading-6 max-sm:!text-xs">
